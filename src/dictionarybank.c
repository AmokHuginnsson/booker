...
OEditControlResource g_psDictionaryBankEditControls [ ] =
	{
		{ 160, "", "^[a-zA-Z±¡æÆêÊ³£ñÑóÓ¶¦¼¬¿¯ \\.-]*$", false, false, false, false, 8 },
		{ 32, "", "^[a-zA-Z±¡æÆêÊ³£ñÑóÓ¶¦¼¬¿¯ ]*$", false, false, false, false, 8 },
		{ 48, "", "^[0-9a-zA-Z±¡æÆêÊ³£ñÑóÓ¶¦¼¬¿¯ \\.-]*$", false, false, false, false, 8 },
...
OResource x_tag_g_psDictionaryBankResources [ ] =
	{
		...
		& g_psDictionaryBankListControls [ 0 ],	NULL, 0, NULL
		},
		{
