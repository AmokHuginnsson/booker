...
\newcommand{\sig}{\amok{\Large{\color{Blue!60!black}{\issuer}}}}
\begin{document}
\noindent
\begin{flushright}
...
\begin{footnotesize}
	...
	\begin{flushright}
		...
		\begin{tabular}{| r | r | r | r |}
			\hline
				\textbf{Stawka VAT}&\textbf{Warto¶æ netto}&\textbf{Kwota VAT}&\textbf{Warto¶æ brutto} \\
			\hline
				\taxes
			\hline
